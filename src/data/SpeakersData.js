...
export const Speaker_data = [
  ...
  new Speaker(
    "V Vigneswari",
    "V. Vigneswari IAS is the honorable District Collector of Kottayam, standing as a prominent figure leading with unwavering passion and purpose. She has held significant positions in the public sector, including serving as the Managing Director of Kerala Tourism Development Corporation (KTDC) and as the Director of Collegiate Education. As a 2015 batch Kerala cadre IAS officer, she began her IAS journey as an Assistant Secretary at the Department of Economic Affairs. Prior to her illustrious career in public service, Vigneswari started her professional journey in the corporate world, working as an Assistant System Engineer at TCS. Overall, V. Vigneswari IAS is a visionary individual with a profound commitment to her enduring dream of creating a nation free from child labor. Her leadership is characterized by an emphasis on valuing people's opinions and actively seeking them to prioritize issues that require immediate attention.",
    vv
  ),
  new Speaker(
    "Siddique Kappan",
  ...
  new Speaker(
    "Anoop Ambika",
    "Anoop P Ambika is the CEO of Kerala Startup Mission (KSUM). With over 26 years of rich industry experience, Anoop's proficiency spans domains including international sales and marketing, policy making, Artificial Intelligence and Machine Learning, Life Sciences, and entrepreneurship. Prior to becoming the CEO of KSUM, Mr. Anoop was the CEO of the biotech firm Genpro Research. He had previously served as the CEO of the clinical data management company Kreara Solutions for over 12 years. Mr. Anoop has co-founded several technology start-ups and also represents Kerala Knowledge Economy Mission (KKEM) in the Kerala State Planning Board. He has served as the patron of Natana, the arts and cultural forum for IT companies in Kerala, highlighting his commitment to fostering creativity and artistic expression. As the key person at Kerala Startup Mission, Anoop is responsible for leading the development and execution of a decision sciences product and services strategy using AI and advanced analytics.",
    aa
  ),
  new Speaker(
    "Anaswara Ramesh",
