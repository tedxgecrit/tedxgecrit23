    ...
    return(
        <Container section='meetus'>
            <div className="w-full h-[600px] mb-[100px]   flex flex-col items-center justify-center text-center">
                <div className="md:w-[75%] w-[89%] md:text-[28px] text-[24px] mb-[20px] font-light">This initiative would not have been possible without the generous support of our sponsors and team members. ❤️</div>            
